...
const Footer = () => {
  return (
    <div className="  flex flex-col  items-center sm:items-end text-white w-full h-full px-4 sm:px-10 2xl:px-80 2xl:pt-20 relative overflow-hidden pt-20 lg:pt-40 mt-32 bg-black">
      <video
