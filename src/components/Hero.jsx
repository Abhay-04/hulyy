...
const Hero = () => {
  return (
    <div className="w-full h-[150vh]  bg-black text-white grid grid-col-12 px-4 sm:px-10 2xl:px-80 pt-20 relative overflow-hidden">
      <video
      ...
      <div className="relative z-10 text-white ">
        <h2 className="text-7xl font-bold pt-24 ">
          Everything App <br></br> for your teams
        </h2>
        <p className="text-lg w-[40%] py-6 leading-normal">
      ...
      <div className="z-10 2xl:w-[80%] 2xl:mt-36">
        <img
